...
[source,sh]
----
find . -type f \( -name "fetchAndParseM3U.ts" -o -name "StreamingService.ts" -o -name "M3UEntry.ts" -o -name "parseM3U.ts" -o -name "route.ts" -o -name "page.tsx" -o -name "PlayerClient.tsx" -o -name "PlayerButton.tsx" -o -name "ChannelCard.tsx" \) -exec sh -c 'echo {}; cat {}' \; 
----
